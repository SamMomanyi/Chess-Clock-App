...
//a handy way to show what is happening on the TimeScreen
data class TimeScreenState (
    ...
    val countDownTime1 : Long = 300_00L,
    val countDownTime2 :  Long = 300_00L,
    val defaultCountDownFormat : Long = 300_00L,
